...
public class InsideOperationWebServiceImpl implements InsideOperationWebService {
  ...
  protected static final String DIRECCION_EMAIL = "https://inside.carm.es/inside/";
  protected static final String TOKENFILE = "/token";
  protected static final String FORMATO_FECHA = "\\d{4}-\\d{2}-\\d{2}";
